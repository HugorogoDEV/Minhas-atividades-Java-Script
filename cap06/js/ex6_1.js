...
frm.addEventListener("submit", (e) => {
    ...
    pacientes.push(nome)        // adiciona o nome no final do vector
...
// adiciona um "ouvinte" para o event click no btUrgencia que está no form
...
frm.btAtender.addEventListener("click", () => {
        ...
        respNome.innerText = atender        // exiber o nome do pacientes em atendimento
        let lista = ""      // string para concatenar pacientes
        pacientes.forEach((paciente, i) => (lista += `${i + 1}. ${paciente}\n`))
        respLista.innerText = lista     // exibe a lista de pacientes na página
})